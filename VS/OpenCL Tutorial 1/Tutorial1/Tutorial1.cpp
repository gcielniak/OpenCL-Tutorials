...
void print_help()
{
	...
	cerr << "  -v : list all platforms and devices, verbose level [0, 1, 2, 3]" << endl;
...
int main(int argc, char **argv)
{
	...
	queue.enqueueNDRangeKernel(kernel_add, cl::NullRange, cl::NDRange(A.size()), cl::NullRange, NULL);
